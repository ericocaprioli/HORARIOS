const pdfLinks = [
  ...
  { title: '1A', filename: '1A.pdf', category: 'turma', theme: 'theme-turma', reference: 'Agro' },
  { title: '2A', filename: '2a.pdf', category: 'turma', theme: 'theme-turma', reference: 'HK' },
  { title: '3A', filename: '3a.pdf', category: 'turma', theme: 'theme-turma', reference: 'HF' },
  { title: '6A', filename: '6a.pdf', category: 'turma', theme: 'theme-turma', reference: 'América' },
  { title: '6B', filename: '6b.pdf', category: 'turma', theme: 'theme-turma', reference: 'Sapiens' },
  { title: '7A', filename: '7a.pdf', category: 'turma', theme: 'theme-7a', reference: 'Grécia' },
  { title: '7B', filename: '7b.pdf', category: 'turma', theme: 'theme-turma', reference: 'Homo' },
  { title: '8A', filename: '8a.pdf', category: 'turma', theme: 'theme-turma', reference: 'Fatorial' },
